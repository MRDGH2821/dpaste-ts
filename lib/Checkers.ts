...
/**
 * Checks if the size of input is less than 250,000 bytes
...
/**
 * Checks if the syntax is valid according to dpaste.com
...
/**
 * Checks if the expiry days is valid according to dpaste.com
