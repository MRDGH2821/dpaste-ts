...
/**
 * Options accepted by dpaste API
 * Mirrors HTTP POST parameters in https://dpaste.com/api/v2/
 * @extends NodeJS.Dict<string|number> Required for `queryStringify` function
 */
